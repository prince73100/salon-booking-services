    ...
    <div className='Service-info  min-h-80  mt-4' >
      ...
      <div className="service-content">
        ...
        <div className="book-now w-3/5 mt-5 mb-4 ml-5">
          <Link to={`${state === true ? `/select-one-service` : '/login'}`} className='bg-rose-500 font-serif p-3 px-5 text-white font-bold transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover: duration-300'>Book now</Link>
        </div>
      </div>
    </div>
  )
