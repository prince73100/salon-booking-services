      ...
      <div className="sub-hero-page mt-5 w-9/12">
        <div className="lg:flex lg:justify-center lg:items-center headn-hearo   ">
          <div className="lg:w-1/2">
            ...
            <p className="lg:text-xl md:text-lg text-base  text-justify mt-10">
              "Expand your reach and attract more clients by joining a platform
              designed to help salons succeed. Simplify your bookings, manage
              your clients, and thrive."
            </p>
            {!isregistered && <div className="hero-btn mt-10">
              <Link
                to={"/regiteredbusiness"}
                className="bg-rose-500 text-white  font-bold p-5 rounded-lg"
              >
                Join Now
              </Link>
            </div>}
        ...
        <div className="featured-highlights mt-20 ">
          ...
          <div className="offers-box flex flex-row flex-wrap justify-center gap-20 mt-20">
            {offerpage.map((imgsrc, index) => {
              return (
                <div className="offers-sub-box " key={index}>
                  <img
                    src={imgsrc.imgname}
                    alt=""
                    width={400}
